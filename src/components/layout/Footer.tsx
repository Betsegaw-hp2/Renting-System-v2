...
export function Footer({ scrollToSection, howItWorksRef, aboutRef, contactRef }: FooterProps) {
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {howItWorksRef && scrollToSection ? (
                <li>
                  <button onClick={() => scrollToSection(howItWorksRef)} className="text-gray-400 hover:text-white">
                    How It Works
                  </button>
                </li>
              ) : (
