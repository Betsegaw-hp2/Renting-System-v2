...
// Root does not need ref forwarding
...
// Trigger may receive ref, forward it
...
// Header, Footer, Title, Description don't need refs
...
export function DialogDescription(
  ...
  return <DialogPrimitive.Description className={cn("text-muted-foreground text-sm", props.className)} {...props} />
}
