...
export default function HomePage() {
      ...
      try {
        ...
        if (user) {
          ...
          if (user.role === "owner") {
            ...
            // Owners might also have rental history
  ...
  const getDefaultTab = () => {
    if (user?.role === "owner") return "myListings"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-blue-100 mb-8">
                {user?.role === "owner"
                  ? "Manage your properties and find new tenants"
                  : user?.role === "admin"
                    ? "Monitor platform activity and manage users"
                    : "Find your perfect rental from thousands of listings"}
              </p>
          ...
          <div className="container mx-auto px-4">
            <Tabs defaultValue={getDefaultTab()} className="w-full">
              <TabsList className="mb-8">
                ...
                {user?.role === "owner" && (
                  <TabsTrigger value="myListings" className="text-sm md:text-base">
              ...
              <TabsContent value="recommended" className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {["Apartments", "Houses", "Vacation Rentals", "Commercial"].map((category) => (
                      <Card key={category} className="hover:shadow-md transition-shadow cursor-pointer">
                        <CardContent className="p-6 flex flex-col items-center text-center">
                          ...
                          <p className="text-gray-500 text-sm">100+ listings</p>
                        </CardContent>
                      </Card>
                    ))}
                  </div>
              ...
              {user?.role === "owner" && (
                <TabsContent value="myListings" className="space-y-8">
                  <div>
                    <div className="flex justify-between items-center mb-6">
                      <h2 className="text-2xl font-bold">My Properties</h2>
                      <Button onClick={() => navigate("/listings/create")}>Add New Property</Button>
                    </div>
              ...
              {/* Rental History Tab - For Tenants and Owners */}
              {(user?.role === "renter" || user?.role === "owner") && (
                <TabsContent value="history" className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold mb-6">Your Rental History</h2>
                    ...
                    {isLoading ? (
                      ...
                      <Card>
                        ...
                        <CardFooter className="bg-gray-50">
                          <Button variant="outline" className="w-full" onClick={() => navigate("/rentals/history")}>
